			...
			<div class="pages">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td width="64%">
							部门：<s:property value="leave.creator.department.name"/>
						</td>
					</tr>
					<tr>
						<td>
							开始时间：<s:property value="%{getText('{0,date,yyyy-MM-dd}',{leave.startTime})}"/>
						</td>
						<td>
							结束时间：<s:property value="%{getText('{0,date,yyyy-MM-dd}',{leave.endTime})}"/>
						</td>
					</tr>
					<tr>
						<td>
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td>
							审批意见：<s:property value="leave.approveOpinion"/>
						</td>
					</tr>
					<tr>
						<td>
							<textarea name="leave.approveOpinion" id="textarea" cols="45" rows="5"></textarea>
						</td>
					</tr>
					<!--表单提交行-->
					<tr>
