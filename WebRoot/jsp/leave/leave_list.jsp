...
<div class="action  divaction">
	...
	<!--增加报销单 区域 开始-->
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="pageUtil.items" id="leave" begin="0" status="s">
	          <tr>
	          	<td><a href="leave_getLeaveById.action?leave.id=<s:property value="#leave.id"/>">
	          		<s:property value="#leave.id" />
	          	</a></td>
	          	<td><s:property value="#leave.creator.name" />请假
	          	<s:property value="#leave.leaveDay" /> 天</td>
	            ...
	            <td><s:date name="#leave.ModifyTime" format="yyyy-MM-dd HH:mm" /></td>
	          	...
	          	<td>
	          		<a href="leave_getLeaveById.action?leave.id=<s:property value="#leave.id" />">
