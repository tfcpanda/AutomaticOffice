...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			$("#AddRow").click(function(){		
				...
				tr.find("td").get(2).innerHTML="<input  name=detailList["+j+"].description  id=description"+j+" type=hidden value="+description+" />"+description;		
		...
		var i=parseInt(<s:property value="claimVoucher.claimVoucherDetails.size"/>);
		
		var rowNumber=parseInt(<s:property value="claimVoucher.claimVoucherDetails.size"/>);
	...
	<div class="action  divaction">
		...
		<div class="pages">
			...
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="claimVoucher.claimVoucherDetails.size"/>"/>
			<input type="hidden" id="claimId" name="claimVoucher.id" value="<s:property value="claimVoucher.id"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  ...
                  <tr>
                    ...
                    <td>部&nbsp;&nbsp;门：<s:property value="claimVoucher.creator.department.name"/></td>
                    <td>职&nbsp;&nbsp;&nbsp;&nbsp;位：<s:property value="claimVoucher.creator.position.nameCn"/></td>
                  </tr>
                  <tr>
                    <td>总金额：
                    <s:textfield name="claimVoucher.totalAccount" id="totalAccount" readonly="true" />
                    </td>
                    ...
                    <s:hidden id="status" name="claimVoucher.status" value="%{claimVoucher.status}"></s:hidden>
                  </tr>
                  <tr>
                  	<td colspan="4"><p>-------------------------------------------------------------------------------</p></td>
                  </tr>
				...
				<table id="myTable" width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					...
					<s:iterator value="claimVoucher.claimVoucherDetails" id="claimDetail" begin="0" status="s">
						<tr>
							<td>
							...
							<td>
								...
								<s:property value="#claimDetail.account"/>
							</td>
							<td>
								<s:hidden id="description%{#s.index}" name="detailList[%{#s.index}].description" value="%{#claimDetail.description}"/>
								<s:property value="#claimDetail.description" />
							</td>
							<td>
				...
				<table id="detailTable" width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						...
						<td width="30%"><input type="text" name="claimVoucherDetail.description" id="description" /><span class=notice>*</span></td>
				...
				<tr>
					...
					<tr>
						<td>*事由：</td>
						<td colspan="3">
						<s:textarea rows="5" cols="66" name="claimVoucher.event"
										id="event"></s:textarea>
						</td>
					</tr>
