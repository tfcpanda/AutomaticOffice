...
<body>
    <div class="action  divaction">
    	<div class="t">审核报销单</div>
          ...
          <p>&nbsp;</p>
				...
				<tr>
					...
					<td><s:property value="#claimDetail.description"/></td>
				</tr>
				</s:iterator>
      </table>
      <p>&nbsp;</p>
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
      	<s:iterator value="claimVoucher.checkResults" id="checkResult" begin="0" status="s">
         <tr>
		...
		<tr>
		 ...
		 <tr>
			<td colspan="3" class="submit">
				...
				<s:hidden id="claimId" name="checkResult.claimVoucher.id" value="%{claimVoucher.id}"/>
